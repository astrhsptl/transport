...
ALLOWED_HOSTS = ['v1852484.hosted-by-vdsina.ru']
...
REST_FRAMEWORK = {
    ...
    # ],
    # "DATETIME_INPUT_FORMATS": time.strftime('%d/%m/%Y %H:%M:%S'),
    # "DATETIME_FORMAT": time.strftime('%d/%m/%Y %H:%M:%S'),
    # "DATE_FORMAT": time.strftime('%d/%m/%Y'),
    # "DATE_INPUT_FORMATS": time.strftime('%d/%m/%Y'),
    # "TIME_FORMAT": time.strftime('%H:%M:%S'),
    # "TIME_INPUT_FORMATS": time.strftime('%H:%M:%S'),
...
REDIS_PORT = 6379 #env('REDIS_HOST')
REDIS_HOST = '127.0.0.1' #env('REDIS_PORT')
